...
import com.apbiomedicale.repository.VideoRepository;
...
class VideoResourceIT {
    ...
    private static final LocalDate DEFAULT_DATE_CAPTURE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_CAPTURE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().nom(DEFAULT_NOM).dateCapture(DEFAULT_DATE_CAPTURE).duree(DEFAULT_DUREE);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().nom(UPDATED_NOM).dateCapture(UPDATED_DATE_CAPTURE).duree(UPDATED_DUREE);
        return video;
    }
    ...
    void createVideo() throws Exception {
        ...
        assertThat(testVideo.getDateCapture()).isEqualTo(DEFAULT_DATE_CAPTURE);
    ...
    void getAllVideos() throws Exception {
        ...
        restVideoMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateCapture").value(hasItem(DEFAULT_DATE_CAPTURE.toString())))
    ...
    void getVideo() throws Exception {
        ...
        restVideoMockMvc
            ...
            .andExpect(jsonPath("$.dateCapture").value(DEFAULT_DATE_CAPTURE.toString()))
    ...
    void putExistingVideo() throws Exception {
        ...
        updatedVideo.nom(UPDATED_NOM).dateCapture(UPDATED_DATE_CAPTURE).duree(UPDATED_DUREE);
        ...
        assertThat(testVideo.getDateCapture()).isEqualTo(UPDATED_DATE_CAPTURE);
    ...
    void partialUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.dateCapture(UPDATED_DATE_CAPTURE);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.nom(UPDATED_NOM).dateCapture(UPDATED_DATE_CAPTURE).duree(UPDATED_DUREE);
