...
import com.apbiomedicale.repository.MedecinRepository;
...
class MedecinResourceIT {
    ...
    public static Medecin createEntity(EntityManager em) {
        Medecin medecin = new Medecin().specialite(DEFAULT_SPECIALITE);
        return medecin;
    }
    ...
    public static Medecin createUpdatedEntity(EntityManager em) {
        Medecin medecin = new Medecin().specialite(UPDATED_SPECIALITE);
        return medecin;
    }
    ...
    void putExistingMedecin() throws Exception {
        ...
        updatedMedecin.specialite(UPDATED_SPECIALITE);
    ...
    void fullUpdateMedecinWithPatch() throws Exception {
        ...
        partialUpdatedMedecin.specialite(UPDATED_SPECIALITE);
