...
import com.apbiomedicale.domain.Patient;
import com.apbiomedicale.repository.PatientRepository;
...
class PatientResourceIT {
    ...
    public static Patient createEntity(EntityManager em) {
        Patient patient = new Patient().profession(DEFAULT_PROFESSION);
        return patient;
    }
    ...
    public static Patient createUpdatedEntity(EntityManager em) {
        Patient patient = new Patient().profession(UPDATED_PROFESSION);
        return patient;
    }
    ...
    void putExistingPatient() throws Exception {
        ...
        updatedPatient.profession(UPDATED_PROFESSION);
    ...
    void partialUpdatePatientWithPatch() throws Exception {
        ...
        partialUpdatedPatient.profession(UPDATED_PROFESSION);
