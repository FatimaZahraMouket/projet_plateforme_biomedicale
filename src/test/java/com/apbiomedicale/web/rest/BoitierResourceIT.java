...
import com.apbiomedicale.repository.BoitierRepository;
...
class BoitierResourceIT {
    ...
    public static Boitier createEntity(EntityManager em) {
        Boitier boitier = new Boitier().type(DEFAULT_TYPE).ref(DEFAULT_REF).nbrBranche(DEFAULT_NBR_BRANCHE);
        return boitier;
    }
    ...
    public static Boitier createUpdatedEntity(EntityManager em) {
        Boitier boitier = new Boitier().type(UPDATED_TYPE).ref(UPDATED_REF).nbrBranche(UPDATED_NBR_BRANCHE);
        return boitier;
    }
    ...
    void createBoitier() throws Exception {
        ...
        assertThat(testBoitier.getRef()).isEqualTo(DEFAULT_REF);
    ...
    @Test
    @Transactional
    void putExistingBoitier() throws Exception {
        // Initialize the database
        boitierRepository.saveAndFlush(boitier);
        ...
        updatedBoitier.type(UPDATED_TYPE).ref(UPDATED_REF).nbrBranche(UPDATED_NBR_BRANCHE);
        ...
        assertThat(testBoitier.getRef()).isEqualTo(UPDATED_REF);
    ...
    void partialUpdateBoitierWithPatch() throws Exception {
        ...
        partialUpdatedBoitier.ref(UPDATED_REF).nbrBranche(UPDATED_NBR_BRANCHE);
    ...
    void fullUpdateBoitierWithPatch() throws Exception {
        ...
        partialUpdatedBoitier.type(UPDATED_TYPE).ref(UPDATED_REF).nbrBranche(UPDATED_NBR_BRANCHE);
