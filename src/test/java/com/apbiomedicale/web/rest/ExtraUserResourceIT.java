...
import com.apbiomedicale.domain.ExtraUser;
import com.apbiomedicale.repository.ExtraUserRepository;
...
class ExtraUserResourceIT {
    ...
    private static final Long DEFAULT_NUMERO_TELEPHONE = 1L;
    private static final Long UPDATED_NUMERO_TELEPHONE = 2L;
    ...
    void getAllExtraUsers() throws Exception {
        ...
        restExtraUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].numeroTelephone").value(hasItem(DEFAULT_NUMERO_TELEPHONE.intValue())))
    ...
    void getExtraUser() throws Exception {
        ...
        restExtraUserMockMvc
            ...
            .andExpect(jsonPath("$.numeroTelephone").value(DEFAULT_NUMERO_TELEPHONE.intValue()))
    ...
    void partialUpdateExtraUserWithPatch() throws Exception {
        ...
        partialUpdatedExtraUser.cin(UPDATED_CIN).nationalite(UPDATED_NATIONALITE);
