...
import com.apbiomedicale.repository.CapteurRepository;
...
class CapteurResourceIT {
    ...
    private static final Long DEFAULT_VALEUR_MIN = 1L;
    private static final Long UPDATED_VALEUR_MIN = 2L;

    private static final Long DEFAULT_VALEUR_MAX = 1L;
    private static final Long UPDATED_VALEUR_MAX = 2L;
    ...
    void getAllCapteurs() throws Exception {
        ...
        restCapteurMockMvc
            ...
            .andExpect(jsonPath("$.[*].valeurMin").value(hasItem(DEFAULT_VALEUR_MIN.intValue())))
            .andExpect(jsonPath("$.[*].valeurMax").value(hasItem(DEFAULT_VALEUR_MAX.intValue())));
    }
    ...
    void getCapteur() throws Exception {
        ...
        restCapteurMockMvc
            ...
            .andExpect(jsonPath("$.valeurMin").value(DEFAULT_VALEUR_MIN.intValue()))
            .andExpect(jsonPath("$.valeurMax").value(DEFAULT_VALEUR_MAX.intValue()));
    }
    ...
    @Test
    @Transactional
    void putExistingCapteur() throws Exception {
        // Initialize the database
        capteurRepository.saveAndFlush(capteur);
