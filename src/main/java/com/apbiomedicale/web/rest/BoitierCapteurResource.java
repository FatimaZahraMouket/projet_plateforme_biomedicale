...
import com.apbiomedicale.repository.BoitierCapteurRepository;
...
/**
 * REST controller for managing {@link com.apbiomedicale.domain.BoitierCapteur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BoitierCapteurResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/boitier-capteurs/{id}", consumes = { "application/json", "application/merge-patch+json" })
