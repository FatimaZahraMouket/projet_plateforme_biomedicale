...
import com.apbiomedicale.repository.BoitierPatientRepository;
...
/**
 * REST controller for managing {@link com.apbiomedicale.domain.BoitierPatient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BoitierPatientResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/boitier-patients/{id}", consumes = { "application/json", "application/merge-patch+json" })
