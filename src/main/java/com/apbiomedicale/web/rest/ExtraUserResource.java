...
/**
 * REST controller for managing {@link com.apbiomedicale.domain.ExtraUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<ExtraUser> partialUpdateExtraUser(
        ...
        Optional<ExtraUser> result = extraUserRepository
            ...
            .map(existingExtraUser -> {
                ...
                if (extraUser.getNationalite() != null) {
                    existingExtraUser.setNationalite(extraUser.getNationalite());
                }
                if (extraUser.getAdresse() != null) {
                    existingExtraUser.setAdresse(extraUser.getAdresse());
                }
                if (extraUser.getGenre() != null) {
                    existingExtraUser.setGenre(extraUser.getGenre());
                }
