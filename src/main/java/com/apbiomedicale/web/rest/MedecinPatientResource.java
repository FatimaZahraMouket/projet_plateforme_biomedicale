...
import com.apbiomedicale.repository.MedecinPatientRepository;
...
/**
 * REST controller for managing {@link com.apbiomedicale.domain.MedecinPatient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MedecinPatientResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/medecin-patients/{id}", consumes = { "application/json", "application/merge-patch+json" })
