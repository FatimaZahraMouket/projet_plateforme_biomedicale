            ...
            <tbody>
              {videoList.map((video, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{video.nom}</td>
                  <td>{video.dateCapture ? <TextFormat type="date" value={video.dateCapture} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td>{video.duree}</td>
                  <td>{video.camera ? <Link to={`/camera/${video.camera.id}`}>{video.camera.id}</Link> : ''}</td>
