...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './camera.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAMERA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAMERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAMERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAMERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAMERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAMERA actions', async () => {
      const expectedActions = [
        {
