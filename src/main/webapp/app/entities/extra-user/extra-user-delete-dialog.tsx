...
export const ExtraUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="appbiomedicaleApp.extraUser.delete.question">
        <Translate contentKey="appbiomedicaleApp.extraUser.delete.question" interpolate={{ id: extraUserEntity.id }}>
